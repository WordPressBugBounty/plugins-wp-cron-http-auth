...
How to use: Visit the plugin settings, enter your HTTP Auth credentials, save changes, done.

Everything happens silently and automatically in the background.

> 👉 Supports defined constants via wp-config.php
> 👉 Super lightweight, fast, and effective
> 👉 Plugin uses only 30KB of code
